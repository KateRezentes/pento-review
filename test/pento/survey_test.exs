defmodule Pento.SurveyTest do
  ...
  describe "demographics" do
    ...
    @valid_attrs %{sex: "some sex", year_of_birth: 42}
    @update_attrs %{sex: "some updated sex", year_of_birth: 43}
    @invalid_attrs %{sex: nil, year_of_birth: nil}
    ...
    test "create_demographic/1 with valid data creates a demographic" do
      ...
      assert demographic.sex == "some sex"
    ...
    test "update_demographic/2 with valid data updates the demographic" do
      ...
      assert demographic.sex == "some updated sex"
